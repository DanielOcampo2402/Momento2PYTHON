...
print("---- Digite (1) si desea ingresar un cliente e informacion de cuenta ----")
print("---- Digite (2) para consultar el saldo ----")
print("---- Digite (3) para ingresar o retirar dinero ----")
print("---- Digite (0) para cerrar el menú ----")
print("")
