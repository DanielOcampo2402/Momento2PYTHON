...
print("")
print("------------------------- MENÚ -----------------------------")
print("---- Ingrese (1) para ingresar un ciclista ----")
print("---- Ingrese (2) para mostrar los ciclistas que se registraron en la competencia ----")
print("---- Ingrese (3) para calcular el mejor tiempo entre los ciclistas que compitieron -----")
...
while(opcion != 0):
    ...
    if(opcion == 1):
        ...
        ciclista.pais = input("Ingrese el país que representa el ciclista: ")
